...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask, XK_s, spawn, SHCMD("curl -F\"file=@$(import -window root $HOME/Pictures/Screenshots/$(date +%d%m%y-%H%M%S).png && echo \"/home/zero/Pictures/Screenshots/$(ls $HOME/Pictures/Screenshots/ -t | head -1)\")\" https://0x0.st | xclip -selection clipboard && notify-send -t 1000 \"Screenshot has been copied .~.\"") },
